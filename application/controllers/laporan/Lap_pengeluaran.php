...
class Lap_pengeluaran extends CI_Controller {
	...
	var $tables =   "";			
	var $file   =   "lap_pengeluaran";
	var $pk     =   "";
	var $title  =   "Laporan Pengeluaran";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Laporan</a></li>										
	<li class='breadcrumb-item active'><a href='laporan/lap_pengeluaran'>Lap Pengeluaran</a></li>										
	</ol>";				          
	...
	{								
		$data['isi']    = "lap_pengeluaran";		
		$data['title']	= $this->title;	
		$data['bread']	= $this->bread;																																		
		$data['page']		= "laporan/lap_pengeluaran";				
