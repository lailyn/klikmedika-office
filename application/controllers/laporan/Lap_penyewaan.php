...
class Lap_penyewaan extends CI_Controller {

	var $tables =   "";			
	var $file   =   "lap_penyewaan";
	var $pk     =   "";
	var $title  =   "Laporan Penyewaan";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Laporan</a></li>										
	<li class='breadcrumb-item active'><a href='laporan/lap_penyewaan'>Lap Penyewaan</a></li>										
	</ol>";				          
	...
	{								
		$data['isi']    = "lap_penyewaan";		
		$data['title']	= $this->title;	
		$data['bread']	= $this->bread;																																		
		$data['page']		= "laporan/lap_penyewaan";				
