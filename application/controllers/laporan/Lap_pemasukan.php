...
class Lap_pemasukan extends CI_Controller {

	var $tables =   "";			
	var $file   =   "lap_pemasukan";
	var $pk     =   "";
	var $title  =   "Laporan Pemasukan";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Laporan</a></li>										
	<li class='breadcrumb-item active'><a href='laporan/lap_pemasukan'>Lap Pemasukan</a></li>										
	</ol>";				          
	...
	{								
		$data['isi']    = "lap_pemasukan";		
		$data['title']	= $this->title;	
		$data['bread']	= $this->bread;																																		
		$data['page']		= "laporan/lap_pemasukan";				
