...
class Lap_penerimaan extends CI_Controller {
	...
	var $tables =   "";			
	var $file   =   "lap_penerimaan";
	var $pk     =   "";
	var $title  =   "Laporan Penerimaan";
	var $bread	=   "<ol class='breadcrumb'>
	<li class='breadcrumb-item'><a>Laporan</a></li>										
	<li class='breadcrumb-item active'><a href='laporan/lap_penerimaan'>Penerimaan</a></li>										
	</ol>";				          
	...
	{								
		$data['isi']    = "lap_penerimaan";		
		$data['title']	= $this->title;	
		$data['bread']	= $this->bread;																																		
		$data['page']		= "laporan/lap_penerimaan";				
