                 ...
                 <div class="row">
                   <div class="col-12">
                     ...
                     <div class="form-group row">
                       ...
                       <div class="col-sm-3">
                         <input type="file" id="fotoInput" accept="image/*" class="form-control form-control-sm" />
                         <input type="hidden" name="logo_base64" id="logoBase64">
                         <img id="previewFoto" src="" style="max-width: 150px; margin-top: 10px;">
                       </div>
                     </div>
                     <div class="form-group row">
         ...
         document.getElementById('fotoInput').addEventListener('change', function(e) {
           ...
           reader.onload = function(event) {
             ...
             img.onload = function() {
               ...
               // Kompres dan ubah ke base64
               const dataUrl = canvas.toDataURL('image/jpeg', 0.7); // kualitas 70%
