      ...
      <?php                       
		...
		if($set=="insert"){
			if($mode == 'insert'){
				...
				$form = "approve";              
				$form_id = "<input type='hidden' name='id' value='$row->id_supplier'>";              
			}elseif($mode == 'edit'){
				$row  = $dt_supplier->row();
				$read = "";
				$read2 = "";
      ...
      if(isset($_GET['l'])){
        $link = "master/supplier/lamaran";
      }elseif(isset($_GET['h'])){
        $link = "master/supplier/history";
      }else{
      ...
      <div class="row">
        <div class="col-12 grid-margin">
          <div class="card">
            ...
            <div class="card-body">
              <form action="master/supplier/<?php echo $form ?>" method="POST" enctype="multipart/form-data" class="form-sample">                  
                <div class="row">
                  <div class="col-12">                
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><a href="master/supplier/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a></h4>
          </div>
          <div class="card-body">            
            <div class="box">                            
              <div class="table-responsive">
                <table id="supplier_dt" class="table" style="width:100%">
                  <thead>
                    <tr>
                      <th width="5%">No</th>                                            
                      <th>Nama</th>                           
