                ...
                <div class="row">
                  <div class="col-12">                
                    ...
                    <div class="form-group row">
                      ...
                      <label class="col-sm-2 col-form-label-sm">Diskon (%)</label>
                      <div class="col-sm-2">                        
                        <input type="text" data-type="currency" <?php echo $read ?> value="<?php echo $tampil = ($row!='') ? $row->current_discount : "" ; ?>" name="current_discount" placeholder="Harga Diskon" class="form-control form-control-sm " />
                      </div>                    
