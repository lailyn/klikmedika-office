      ...
      <div class="col-12 grid-margin">        
        ...
        <div class="card">
          <div class="card-header">
            <form method="post" action="laporan/lap_pemasukan/index" >
              <div class="row">                                
                <div class="col-sm-2">                  
                ...
                <div class="col-sm-2">
                  <div class="form-group">                    
                    ...
                    <a href="laporan/lap_pemasukan" class="btn text-white btn-sm btn-warning mt-2"> Reset</a>                              
                  </div>
                </div>
              </div>                          
            </form>
            ...
            <div class="box">                            
              <div class="table-responsive">
                <table id="example1" class="table" style="width:100%">
                  ...
                  $no=1;
                  $where="";$total=0;                                    
                  if($filter_1!="") $where.=" AND md_pemasukan.tgl BETWEEN '$filter_1' AND '$filter_2'";
