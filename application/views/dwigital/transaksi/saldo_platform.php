     <?php
      $absolute_path = "dwigital/transaksi/saldo_platform";
       ...
       <div class="row">
         <div class="col-12 grid-margin">
           <div class="card">
             ...
             <div class="card-body">
               <div class="col-12">
                 <form action="<?= $absolute_path ?>/<?php echo $form ?>" method="POST" class="form-sample">
                   <div class="row">
                     <div class="col-md-12">
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group row">
                         <label class="col-sm-2 col-form-label-sm">Sisa Saldo</label>
                         <div class="col-sm-10">
                           <?php echo $form_id ?>
                           <input type="number" <?php echo $read ?> value="<?php echo $tampil = ($row != '') ? $row->sisa_saldo : ""; ?>" name="sisa_saldo" placeholder="Sisa Saldo" class="form-control form-control-sm" />
                         </div>
                       </div>
                     </div>
                   </div>
                 ...
                 <div class="table-responsive">
                   <table id="example" class="table" style="width:100%">
                     ...
                     <tbody>
                       <?php
                        $no = 1;
                        foreach ($dt_saldo_platform->result() as $isi) {
                          echo "
                    <tr>
                      <td>$no</td>
                      <td>$isi->nama</td>                      
                      <td>Rp. ".mata_uang($isi->sisa_saldo)."</td>                      
