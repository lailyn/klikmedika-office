     <?php
      $absolute_path = "dwigital/produk/platform";
                   ...
                   <div class="row">
                     <div class="col-md-12">
                       <div class="form-group row">
                         <label class="col-sm-2 col-form-label-sm">Platform</label>
                         <div class="col-sm-10">
                           <?php echo $form_id ?>
                           <input type="text" <?php echo $read ?> value="<?php echo $tampil = ($row != '') ? $row->nama : ""; ?>" name="nama" placeholder="Platform" class="form-control form-control-sm " />
                         </div>
                       </div>
                     </div>
                   </div>
                 ...
                 <div class="table-responsive">
                   <table id="example" class="table" style="width:100%">
                     ...
                     <tbody>
                       <?php
                        $no = 1;
                        foreach ($dt_produk_platform->result() as $isi) {
                          echo "
                    <tr>
                      <td>$no</td>
                      <td>$isi->nama</td>                      
