        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="transaksi/pemasukan" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i> View</a></h4>
            </div>
            <div class="card-body">
              <form action="transaksi/pemasukan/<?php echo $form ?>" method="POST" enctype="multipart/form-data" class="form-sample">                  
                <div class="row">
                  <div class="col-12">         
                    ...
                    <div class="form-group row">                    
                      ...
                      <div class="col-sm-2"><a href="transaksi/pemasukan/kategori" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Kategori </a></div>                      
    ...
    <?php }elseif($set=="kategori"){ ?>
      ...
      <div class="row">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title"><a href="transaksi/pemasukan/add" class="btn btn-warning btn-sm"><i class="fa fa-chevron-left"></i> Back</a></h4>
            </div>
            <div class="card-body">
              <form action="transaksi/pemasukan/simpan_kategori" method="POST" enctype="multipart/form-data" class="form-sample">                  
                <div class="row">
                  <div class="col-12">                             
                    <div class="form-group row">                    
                          ...
                          <table id="example1" class="table" style="width:100%">
                            ...
                            foreach($dt_pemasukan_kategori->result() AS $row){
                              ...
                              <tr>
                                <td>$row->kategori</td>
                                <td>"; ?>
                                  <a href="transaksi/pemasukan/delete_pemasukan?id=<?php echo $row->id ?>" onclick="return confirm('Anda yakin?')" class="btn btn-danger btn-xs" title="Hapus"><i class="fa fa-trash"></i></a>                                                            
                              </tr>
                            <?php
                            }
                            ?>
    ...
    <div class="row">
      <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-header">
            <h4 class="card-title"><a href="transaksi/pemasukan/add" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a></h4>
          </div>
          <div class="card-body">            
            <div class="box">                            
              <div class="table-responsive">
                <table id="example1" class="table" style="width:100%">
                  ...
                  <?php 
                  $no=1;
                  $cek = $this->db->query("SELECT md_pemasukan.*,md_pemasukan_kategori.kategori FROM md_pemasukan 
...
function cek_produk(){
  ...
  $.ajax({
      url : "<?php echo site_url('transaksi/pemasukan/cari_produk')?>",
      type:"POST",
